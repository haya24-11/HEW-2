...
void NormalEnemyred::SetupAnimation()
{
    // 歩行アニメ
...
/**/
void NormalEnemyred::ApplyWalkVisual()
{
    m_object->SetTexture("asset/Texture/enemy_slime_red.png");
    m_object->SetSpriteSheet(8, 4);
}

void NormalEnemyred::Attack()
{

}
//モーション追加する時利用してください。

void NormalEnemyred::ApplyIdleVisual()
{
    // 基本は Walk と同じシートを使用
    m_object->SetTexture("asset/Texture/enemy_slime_red.png");
    m_object->SetSpriteSheet(8, 4);
...
void NormalEnemyred::ApplyHitVisual()
{
    m_object->SetTexture("asset/Texture/enemy_slime_down_red.png");
    m_object->SetSpriteSheet(8, 4);
...
void NormalEnemyred::ApplyDieVisual()
{
    m_object->SetTexture("asset/Texture/enemy_slime_down_red.png");
    m_object->SetSpriteSheet(8, 4);
    //m_object->SetTexture("asset/Texture/enemy_slime_down.png");
...
void NormalEnemyred::OnDamaged(int damage)
{
