...
void RendererDrawStart()
{
	...
	g_pDeviceContext->IASetPrimitiveTopology(D3D11_PRIMITIVE_TOPOLOGY_TRIANGLESTRIP); // 頂点の情報を変えれる
...
void RendererUninit()
{
	...
	SAFE_RELEASE(g_pConstantBuffer); // 定数バッファを開放
...
/*
* // サンプルの三角形
{  0.0f,  0.5f, 0.5f,	1.0f,	0.0f,	1.0f,	1.0f	},  // 0番目の頂点座標　{ x, y, z } (r,g,b,a}
{  0.5f, -0.5f, 0.5f,	0.0f,	1.0f,	1.0f,	1.0f	},  // 1番目の頂点座標
{ -0.5f, -0.5f, 0.5f,	1.0f,	1.0f,	0.0f,	1.0f	},  // 2番目の頂点座標

{  0.5f,  0.5f, 0.5f,	1.0f,	0.0f,	1.0f,	1.0f	},  // 3番目の頂点座標　{ x, y, z } (r,g,b,a}
{  0.5f, -0.5f, 0.5f,	0.0f,	1.0f,	1.0f,	1.0f	},  // 4番目の頂点座標
{ -0.5f,  0.5f, 0.5f,	1.0f,	1.0f,	0.0f,	1.0f	},  // 5番目の頂点座標
*/
